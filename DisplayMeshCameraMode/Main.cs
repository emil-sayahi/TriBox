...
";
        ...
        protected override void OnLoad(EventArgs e) {
			...
			Console.WriteLine("Use W, and S to zoom-in and out, A, and D to move about, ESC to quit.");
        }
        ...
        protected override void OnUpdateFrame(FrameEventArgs e) {
            ...
            Icon = DisplayMeshCameraMode.Properties.Resources.PenroseTriBox;
            this.Title = "TriBox Game Engine";
            VSync = VSyncMode.On;
            ...
            if (Keyboard[OpenTK.Input.Key.A])
            {
                ...
                angle += rotation * (float)2.0;
                GL.Rotate(angle, 1.0f, 0.0f, 0.0f);
                Console.WriteLine("View direction: {0}", viewDirection);
            }
            else if (Keyboard[OpenTK.Input.Key.D])
            {
                ...
                GL.Rotate(angle, -1.0f, 0.0f, 0.0f);
                Console.WriteLine("View direction: {0}", viewDirection);
                Console.WriteLine("View direction: {0}", viewDist);
            }
        }
